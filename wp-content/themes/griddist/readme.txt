...
Griddist is a responsive blog theme made for personal bloggers and lifestyle bloggers. Its beautiful and minimalistic look gives this theme a perfectly stylized image whether you're a food-, fashion-, travel- or lifestyle blogger. Theme Everest are always invested in all forms of optimization and Griddist is no exception. In Griddist you'll find a stylized and highly optimized theme with swift load times across the board without any loss of perfomance and responsiveness. All this is bundled with our built-in first-class SEO ( Search Engine Optimization ) which will help you get a head start on search engines like Google and Bing. Get ready to be noticed, with Griddist.
...
Griddist WordPress Theme, Copyright 2018 ThemeEverest
Griddist is distributed under the terms of the GNU GPL
All files coded by me, and fonts (for example Griddist font) is under GPLv2 http://www.gnu.org/licenses/gpl-2.0.html

Griddist bundles the following third-party resources:
...
* Based on Underscores (C) 2012-2015 Automattic, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html) License: GNU General Public License v2 or later License URI: http://www.gnu.org/licenses/gpl-2.0.html Copyright: Automattic http://underscores.me/
* Based on Koji https://wordpress.org/themes/koji/ by Anders Norén, check out his portfolio here: http://www.andersnoren.se/ thank you for releasing the awesome theme under GPlv2, we are extremely grateful and have respectfully used it as a foundation for our own masonry grid theme. The construct.js was not licensed, so we assume it was created by Anders Norén since it can be found in Koji and released under GPLv2. Thank you Anders, if you ever want this theme removed you just let us know. Koji (C) Anders Norén, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
...
* Based on Writer Blogily https://wordpress.org/themes/writer-blogily/
* (C) ThemeEverest, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
* Based on Bloggist https://wordpress.org/themes/bloggist/
* (C) ThemeEverest, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
* Based on Foodie Blog https://wordpress.org/themes/foodie-blog/
* (C) ThemeEverest, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
...
https://pxhere.com/en/photo/1444463
